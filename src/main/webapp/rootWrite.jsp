...
<meta charset="UTF-8">
<title>코스 등록</title>
 <link rel="stylesheet" href="./css/rootwrite.css" />
...
String head = day + "일차의 코스를 입력 하여 주세요!";
%>
</head>
<body>
			...
			<div>
				...
				<div class="right" id="tableContainer">
					<table id="originalTable">
						<tr>
							<td><input type="file" name="img_1" id="file" accept="image/*"></td>
							<td>
								<table>
									<tr>
										<th>장소명</th>
