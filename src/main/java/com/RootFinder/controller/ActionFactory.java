...
import com.RootFinder.controller.action.AdminDeleteCoseAction;
...
import com.RootFinder.controller.action.LikeCoseAction;
...
public class ActionFactory {
	...
	//로그인 확인 후 넘어가는 메인페이지(가연 추가)
		...
		//관심목록 표시
		 else if(command.equals("like_cose"))
		 {
			 action = new LikeCoseAction();
...
//-----------------------[관리자]-----------------------------------
	      ...
	      }else if(command.equals("admin_cose_delete"))
	      {
	    	  action = new AdminDeleteCoseAction();
	      }
		return action;
	}
